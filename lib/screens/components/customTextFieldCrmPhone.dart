...
class CustomTextFieldCrmPhone extends StatefulWidget {
  final String? hint;
  final bool? label;
...
class _CustomTextFeildCrmEmailState extends State<CustomTextFieldCrmPhone> {
  bool _isHidden = true;
  void _visibility() {
    setState(() {
      _isHidden = !_isHidden;
