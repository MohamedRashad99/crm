...
class NotesCustomTextField extends StatefulWidget {
  final String? hint;
  final bool? label;
  ...
  @override
  _NotesCustomTextFieldState createState() => _NotesCustomTextFieldState();
}

class _NotesCustomTextFieldState extends State<NotesCustomTextField> {
  bool _isHidden = true;
  void _visibility() {
    setState(() {
      _isHidden = !_isHidden;
