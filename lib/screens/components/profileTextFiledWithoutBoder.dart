...
class ProfileWithoutBorderTextField extends StatefulWidget {
 // final bool isVisableIcon;
  final String? hint;
  final bool? label;
  ...
  const ProfileWithoutBorderTextField({
   // this.isVisableIcon =false,
    this.hint,
    this.onsave,
    this.onTap,
    this.icon,
  ...
  @override
  _ProfileWithoutBorderTextFieldState createState() => _ProfileWithoutBorderTextFieldState();
}

class _ProfileWithoutBorderTextFieldState extends State<ProfileWithoutBorderTextField> {
  bool _isHidden = true;
  void _visibility() {
    setState(() {
      _isHidden = !_isHidden;
