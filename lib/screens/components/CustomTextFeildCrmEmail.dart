...
class CustomTextFieldCrmEmail extends StatefulWidget {
  final String? hint;
  final bool? label;
  ...
  @override
  _CustomTextFeildCrmEmailState createState() => _CustomTextFeildCrmEmailState();
}

class _CustomTextFeildCrmEmailState extends State<CustomTextFieldCrmEmail> {
  bool _isHidden = true;
  void _visibility() {
    setState(() {
      _isHidden = !_isHidden;
      ...
      child: SizedBox(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: widget.label == true ? "Email" : null,
