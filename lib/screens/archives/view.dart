...
class ArchiveClientsScreen extends StatefulWidget {
  const ArchiveClientsScreen({Key? key}) : super(key: key);

  @override
  State<ArchiveClientsScreen> createState() => _MainScreenState();
}

class _MainScreenState extends State<ArchiveClientsScreen> {
                      ...
                      itemBuilder: (context, index) {
                        return InkWell(
                          ...
                          child:  CustomDismissible(
                            keyName:'item ${[index]}',
                            moveArchive: 'حذف نهائي',
                            titleDialog: 'حذف العميل من الارشيف ؟',
                            subTitleDialog: 'هل انت متاكد من حذف العميل من الارشيف !',
                            buttonDialogConfirmation: 'تاكيد',
                            onTap: (){},
                            child: Container(
